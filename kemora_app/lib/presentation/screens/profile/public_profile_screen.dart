...
class PublicProfileScreen extends StatelessWidget {
    ...
    return Scaffold(
      body: CustomScrollView(
        slivers: [
              ...
              child: Column(
                children: [
                    ...
                    child: Stack(
                      children: [
                        Container(
                          ...
                          child: const Center(child: Icon(Icons.person, size: 64, color: AppColors.outlineVariant)),
                        ),
                        Positioned(
                          bottom: 0,
                          right: 0,
                  ...
                  FadeSlideIn(
                    ...
                    child: Column(
                      children: [
                        Text('Zaki', style: AppTypography.headlineMedium),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text('ELITE TRAVELER', style: AppTypography.labelSmall.copyWith(color: Colors.green)),
                      ],
                    ),
                  ),
                        const SizedBox(height: 16),
                        Text('12 Destinations Visited • Cairo, Egypt', style: AppTypography.bodyMedium.copyWith(color: AppColors.onSurfaceVariant)),
                      ],
                    ),
                  ),
                ],
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.all(24).copyWith(bottom: 120), // Bottom nav padding
              child: Column(
                ...
                children: [
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            Text('ACHIEVEMENTS', style: AppTypography.labelSmall),
                            TextButton(
                              onPressed: () {
                                Navigator.push(context, SlidePageRoute(child: const AllAchievementsScreen()));
                              },
                              child: Text('View All →', style: AppTypography.labelMedium.copyWith(color: AppColors.primaryContainer)),
                            ),
                          ],
                        ),
                        ...
                        child: Row(
                          children: [
                            ...
                            const SizedBox(width: 4),
                            Text('$totalPoints pts', style: AppTypography.labelMedium.copyWith(color: AppColors.primaryContainer)),
                          ],
                        ),
                      ),
                      ElevatedButton(
                        onPressed: () => _showRedeemModal(context, totalPoints),
                  ...
                  Column(
                    children: top4Achievements.map((achievement) => Padding(
                  ...
                  // Nav List
                  _buildNavRow(Icons.bookmark, 'Saved Trips', '4 drafts'),
                  _buildNavRow(Icons.favorite, 'Saved Places', '12 places'),
                  _buildNavRow(Icons.card_giftcard, 'Redeemed Vouchers', null),
                  ...
                  Center(
                    child: TextButton.icon(
                      ...
                      label: Text('Settings', style: AppTypography.labelLarge.copyWith(color: AppColors.onSurfaceVariant)),
                    ),
                  ),
                        Center(
                          child: TextButton.icon(
                            ...
                            label: Text('Log Out', style: AppTypography.labelLarge.copyWith(color: AppColors.error)),
                          ),
                        ),
                      ],
                    ),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(
              Icons.workspace_premium, // You could map icons dynamically based on ID
  ...
  void _showRedeemModal(BuildContext context, int totalPoints) {
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text('$totalPoints pts', style: AppTypography.labelMedium.copyWith(color: AppColors.primaryContainer)),
                ),
              ],
            ),
            const SizedBox(height: 24),
            _buildRewardItem('5% Off Flights', 'EgyptAir', 500, Icons.flight),
            _buildRewardItem('Free Coffee', 'Cilantro Cafe', 150, Icons.local_cafe),
            _buildRewardItem('1 Night Stay', 'Marriott Mena House', 2000, Icons.hotel),
            _buildRewardItem('10% Off Dinner', 'Abou El Sid', 300, Icons.restaurant),
            const SizedBox(height: 24),
            SizedBox(
  ...
  Widget _buildRewardItem(String title, String subtitle, int pointsNeeded, IconData icon) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 16),
      child: Container(
        padding: const EdgeInsets.all(16),
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              child: Text('$pointsNeeded pts', style: AppTypography.labelSmall.copyWith(color: AppColors.onSurfaceVariant)),
            ),
          ],
        ),
      ),
