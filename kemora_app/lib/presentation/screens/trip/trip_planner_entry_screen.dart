...
class _TripPlannerEntryScreenState extends State<TripPlannerEntryScreen> {
              ...
              builder: (context) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    if (tripProvider.state == TripState.loading)
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return GestureDetector(
                              onTap: () {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Trip Detail view coming soon!')));
                              },
  ...
  void _showTripMenu(BuildContext context, TripViewModel provider, dynamic trip) {
